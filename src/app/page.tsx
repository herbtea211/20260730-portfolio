...
export default function Home() {
  return (
          ...
          <main className="max-w-[1440px] mx-auto px-6 md:px-[120px] grid grid-cols-1 md:grid-cols-8 gap-8 mb-50">
              {/* <section className="col-start-2 col-span-6 flex items-start gap-8 py-100"> */}
              <section className="col-start-2 col-span-6 flex flex-col items-center gap-8 py-50 md:py-100 md:flex-row md:items-start">
                <div>
                  <Image
                    src={avatar}
                    alt="Sam"
                ...
                <div>
                  <h1 className="font-hero font-extraBold text-hero-mobile md:text-hero leading-hero-mobile md:leading-hero tracking-hero text-textPrimaryColor">理解問題，設計答案</h1>
